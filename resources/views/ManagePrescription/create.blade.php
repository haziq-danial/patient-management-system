            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Prescription Details for {{ $patient->name }}</h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route('manage-prescription.store', $patient->patient_id) }}" method="post" id="create-prescription-form">
                            @csrf
                    ...
                    <div class="card-footer">
                        <div class="row justify-content-center">
                            <div class="col-6">
                                <a href="{{ route('manage-prescription.index', $patient->patient_id) }}" class="btn btn-secondary">Back</a>
